...
**Target Audience:**
Digital humanities scholars + librarians who may be interested in seeing how text mining methods might be leveraged for gleaning the themes of texts and what questions that might be able to help answer related to censorship.
...
2. I tokenized and tidied the text, filtering out some custom stop words that show up a lot on Whitman's poetry, such as "thy", "thou" and "the". 
